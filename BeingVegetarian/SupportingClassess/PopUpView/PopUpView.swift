...
open class PopUpView: UIView {
    ...
    open class func addPopUpAlertView(_ strHeader: String, leftBtnTitle: String, rightBtnTitle: String, firstLblTitle: String, secondLblTitle: String) {
        ...
        viewCenter.backgroundColor = AppColor.bgColor//.clear//
        ...
        lblMsg1.font = UIFont.systemFont(ofSize: 14.0)//UIFont.systemFont(ofSize: 14.0)
        ...
        btnRight.backgroundColor = AppColor.btnlogincolour
        ...
        if rightBtnTitle == "" {
            ...
            btnLeft.backgroundColor = AppColor.btnlogincolour
    ...
    open class func addValidationView(_ arr: NSMutableArray, strHeader: String, strSubHeading: String) {
        ...
        for i in 0 ..< arr.count {
            ...
            lbl.numberOfLines = 0
            lbl.text = str
            //let font = UIFont(name: "Roboto-Medium", size: 15.0)
        ...
        if strHeader != "" {
            ...
            lblHeaderLine.text = ""
            lblHeaderLine.backgroundColor = AppColor.headerColor
        ...
        labelLine.backgroundColor = AppColor.headerColor
        labelLine.autoresizingMask = [.flexibleRightMargin, .flexibleLeftMargin, .flexibleBottomMargin, .flexibleWidth]
        viewCenter.addSubview(labelLine)
        ...
        btnOk.backgroundColor = AppColor.btnlogincolour
    ...
    open class func addNetworkLostView(strMsg:String){
        ...
        viewCenter.setCornerRadiousAndBorder(AppColor.graybtncolour, borderWidth: 1.0, cornerRadius: 5.0)
        viewCenter.clipsToBounds = true
        ...
        lblHeader.textColor = UIColor.black
        lblHeader.textAlignment = .center
        lblHeader.backgroundColor = AppColor.headerColor
        ...
        let font = UIFont.init(name:"Poppins", size: 14.0)//UIFont.systemFont(ofSize: 14.0)
        ...
        btnTryAgain.setTitleColor(AppColor.btnlogincolour, for: UIControl.State.normal)
        btnTryAgain.titleLabel?.font = UIFont.init(name:"Poppins", size: 17.0)//UIFont.systemFont(ofSize: 17.0)
        ...
        viewCenter.backgroundColor = AppColor.bgColor//.clear////UIColor.white
        ...
        btnClose.backgroundColor = AppColor.btnColor
        btnClose.setTitleColor(AppColor.dividerColor, for: UIControl.State.normal)
        btnClose.titleLabel?.font = UIFont.init(name:"Poppins", size: 17.0)//UIFont.systemFont(ofSize: 17.0)
