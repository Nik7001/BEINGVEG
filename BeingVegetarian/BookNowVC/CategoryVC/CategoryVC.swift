...
class CategoryVC:UIViewController,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    func WS_topRestaurentVC() {
        if HelperClass.isInternetAvailable {
            ...
            let  strUrl = WebServicesLink.cuisines_categorylist
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.img.sd_setImage(with: URL(string:pImage), placeholderImage: UIImage(named: "pizza"))
        cell.headerLabel.text =  dict.GetString(forKey: "title")
